...
//	for k := range default_server.HandlerMap {
//		var filteredHandlers []admission.Handler
//		for i, handler := range default_server.HandlerMap[k] {
//			if namedHandler, ok := handler.(admission.NameGetter); ok && set.Has(namedHandler.Name()) {
//				continue
//			}
//			filteredHandlers = append(filteredHandlers, default_server.HandlerMap[k][i])
//		}
//		default_server.HandlerMap[k] = filteredHandlers
//	}
//}
